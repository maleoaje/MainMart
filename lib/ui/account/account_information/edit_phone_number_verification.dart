...
class EditPhoneNumberVerificationPage extends StatefulWidget {
  ...
  const EditPhoneNumberVerificationPage({Key key, this.verificationType, this.phoneNumber = ''}) : super(key: key);
          ...
          children: <Widget>[
            ...
            Container(
              child: SizedBox(
                  ...
                  child: FlatButton(
                    splashColor: _isButtonDisabled?Colors.transparent:PRIMARY_COLOR,
                    highlightColor: _isButtonDisabled?Colors.transparent:PRIMARY_COLOR,
                    ...
                    color: _isButtonDisabled?Colors.grey[300]:PRIMARY_COLOR,
                    child: Text(
